...
/**
 * internalBindingWhitelist包含内部绑定模块的名称，这些模块被列入白名单以通过process.binding（）进行访问...
 * 这用于为移至internalBinding的模块提供过渡路径。
 */
...
///即使不是以CommonJS样式编写，也可以将其视为module.exports在此文件中。
